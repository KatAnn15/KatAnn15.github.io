...
import { FilteredMovieItemProps } from "./FilteredMovieItemTypes";
import "./FilteredMovieItem.scss";

const FilteredMovieItem: React.FC<FilteredMovieItemProps> = ({
  title,
  poster_path,
  id,
}) => {
  return (
    <Link to={`/movies/${id}`}>
      <div className="filtered-movie_item_wrapper">
        ...
        <div
          className="filtered-movie_item_poster"
